...
class SignupForm extends Component {
  ...
  handleSubmit = (e) => {
    ...
    axios
      .post(
        `${SERVER_HOST}/users/register/${this.state.firstName}/${this.state.surname}/${this.state.email}/${this.state.password}/`
      )
      .then((res) => {
        if (res.data) {
          if (res.data.errorMessage) {
      ...
      <div className="SignupForm">
        ...
        <Grid container spacing={2} className={classes.grid}>
          <Grid
            ...
            md={4}
            lg={4}
            className="SignupFormInfoWrapper LoginFormInfoWrapper"
          >
            <h3>Hello & Welcome</h3>
          ...
          <Grid
            ...
            md={8}
            lg={8}
            className="SignupFormWrapper LoginFormWrapper"
          >
